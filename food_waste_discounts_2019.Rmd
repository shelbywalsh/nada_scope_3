...
# Subtract those words from discount_totals
discount_totals <- discount_totals[!grepl('Oil|Tofu|Tempeh|Tempea|Soy Protein|Pea Protein|Tahini', discount_totals$item),]
...
discount_totals <- discount_totals[!grepl('Gathering Place|Sauce|naise|Vinegar|Mustard|Miso|Tamari|Bay Leaf|Beet Root|Garlic Powder|Onion Powder|Ginger Powder|Garam Masala|Salt|Pesto|Chili |Italian Seasoning|Granules|Paprika Powder|Vanilla Extract', discount_totals$item),]
