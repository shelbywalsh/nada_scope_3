...
dairy_category_15 <- discount_totals %>% 
  filter(grepl('milk|Milk|Cream|cream|Yogurt|yogurt', item))

#Sweet, 11 dairy products!! let's subract and keep pluggin'

# Subtract those words from discount_totals
discount_totals <- discount_totals[!grepl('milk|Milk|Cream|cream|Yogurt|yogurt', discount_totals$item),]
...
vegetable_category_27 <- discount_totals %>% 
  filter(grepl('Squash|Beet|Beets,|Bell Pepper,|Bok Choy|Broccoli,|Brussel Sprouts,|Cabbage,|Carrots,|Celery,|Cilantro|Chard,|Cucumber,|Garlic,|Ginger|Kale|Leeks|Lettuce|Mushroom|Mushrooms|Onion|Parsley|Spinach|Zuchinni', item))
...
# Subtract those words from discount_totals
discount_totals <- discount_totals[!grepl('Squash|Beet|Beets,|Bell Pepper,|Bok Choy|Broccoli,|Brussel Sprouts,|Cabbage,|Carrots,|Celery,|Cilantro|Chard,|Cucumber,|Garlic,|Ginger|Kale|Leeks|Lettuce|Mushroom|Mushrooms|Onion|Parsley|Spinach|Zuchinni', discount_totals$item),]
