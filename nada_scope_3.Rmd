...
cleaning_category_24 <- all_products %>%
  filter(grepl('Castile|Cleaner|Dish|Toothpaste|Crush and Brush|Laundry Soda|Brightener|Borax|Bleach', item)) %>% 
  add_column(prod_cat = 24)

# Subtract those words from all_products
all_products <- all_products[!grepl('Castile|Cleaner|Dish|Toothpaste|Crush and Brush|Laundry Soda|Brightener|Borax|Bleach', all_products$item),]
```
